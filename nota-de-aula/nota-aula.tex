...
% ----------------------------------------------------
% Logo
\pgfdeclareimage[width=.75cm]{logo}{../../latex-estilos/nota-de-aula/imagem/logo-mono.png}
% Info
\pgfdeclareimage[width=.6cm]{nota}{../../latex-estilos/nota-de-aula/imagem/nota.pdf}
% Warning
\pgfdeclareimage[width=.6cm]{atencao}{../../latex-estilos/nota-de-aula/imagem/atencao.pdf}
