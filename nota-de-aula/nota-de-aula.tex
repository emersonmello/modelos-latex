...
\cabecalhoCurso{Engenharia de Telecomunicações}{Configuração de Redes de Computadores Linux}{Prof. Emerson Ribeiro de Mello}{\url{http://docente.ifsc.edu.br/mello/bcd}}{\textbf{Aula 01:} Shell Script}{14/06/2020}
...
\begin{informacao}
	Para executar um \textit{bash script} digite: \dest[green]{\texttt{bash nome-do-arquivo.sh}} ou deixe o arquivo com permissão para execução, com o comando \dest[green]{\texttt{chmod +x nome-do-arquivo.sh}} e executá-lo da seguinte forma: \dest[green]{\texttt{./nome-do-script.sh}}
\end{informacao}
