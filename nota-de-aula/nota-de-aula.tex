...
\begin{tip}
    Para executar: \dest[green]{\texttt{bash nome-do-arquivo.sh}} ou deixe o arquivo com permissão para execução, com o comando \dest[green]{\texttt{chmod +x nome-do-arquivo.sh}} e então execute \destx[green]{\texttt{./nome-do-arquivo.sh}}
\end{tip}
