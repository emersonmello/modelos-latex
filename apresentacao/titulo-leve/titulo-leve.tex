...
\lstinputlisting[style=ansic,caption={Meu primeiro programa em C},label={ola},captionpos=b]{codigos/ola.c}


% escrevendo o código diretamente dentro do frame
 
\begin{lstlisting}[style=java,caption={Meu primeiro programa em Java},label={ola-java},captionpos=b]
