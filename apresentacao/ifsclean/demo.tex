...
% Theme parameters
\usetheme[
    foreground=azulcinza, % cor do texto (usado no título dos slides) 
    ...
    titlebg=azulcinza, % cor do fundo do slide de título
    frametitlefg=azulcinza, % cor do texto do título do frame
    % frametitlebg=redwine, % cor do fundo do título do frame
    % sectionfg=redwine, % cor do texto do slide da seção
    sectionbg=azulcinza, % cor do fundo do slide de seção
    % blocktitlefg=white, % cor do texto do título dos blocos
    blocktitlebg=azulcinza, % cor do fundo do título dos blocos
...
\begin{frame}{Horários}
    {Veja outros ícones em \url{https://ctan.org/pkg/fontawesome5}}
    \begin{itemize}
