...
\usetheme[
    ...
    % titlefg=white, % cor do texto do slide de título
    % titlebg=redwine, % cor do fundo do slide de título
    % sectionfg=white, % cor do texto do slide da seção
    % sectionbg=redwine, % cor do fundo do slide de seção
