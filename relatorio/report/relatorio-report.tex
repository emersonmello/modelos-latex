...
% arara: pdflatex
% arara: pdflatex
% arara: clean: { files: [ relatorio-report.aux, relatorio-report.bbl, relatorio-report.bcf, relatorio-report.cod ] }
% arara: clean: { files: [ relatorio-report.blg, relatorio-report.lof, relatorio-report.lot, relatorio-report.out ] }
% arara: clean: { files: [ relatorio-report.toc, relatorio-report.log, relatorio-report.glo, relatorio-report.glg ] } 
% arara: clean: { files: [ relatorio-report.gls, relatorio-report.glsdefs, relatorio-report.acr, relatorio-report.acn ] } 
% arara: clean: { files: [ relatorio-report.alg, relatorio-report.log, relatorio-report.xdy, glossario.aux ] } 
...
% para permitir que caracteres acentuados no PDF sejam copiados
%\usepackage[T1]{fontenc} 
% para deixar uma fonte mais agradável, porém conflita com o pacote acima
\usepackage{ae} 
