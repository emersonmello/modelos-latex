...
% ------------------------------------------------------------%
\capa{modelo1}{imagens/ifsc-v}
% \capa{modelo2}{imagens/ifsc-v}
...
\subsection{Escopo do projeto}\label{sec:escopo}
...
\subsection{Requisitos funcionais}\label{sec:reqfuncionais}
...
\subsection{Requisitos não funcionais}\label{sec:reqnaofuncionais}
...
\subsection{Regras de negócio}\label{sec:regrasdenegocio}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Só poderá solicitar validação de uma disciplina caso nunca tenha se matriculado na mesma.
    \end{itemize}
\end{enumerate}
