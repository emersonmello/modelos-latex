...
Fulano da Silva,
\papel{Juca Falante}{Comentarista},
\presidente{Odilson Tadeu},
\secretario{Ricardo Escrev},
\secretaria{Maria Escriba},
\titular{Roseana Parti},
\suplente{Jucênica Virtu}}

%-------------------
% A lista abaixo pode ser completamente excluída se não houver ausentes
%-------------------
\listaausentes{
Fulana da Silva,
\capacitacao{Juca Luca},
\aula{Professor Tal}}
...
\item
\blackout{Um parágrafo repleto de informações sensíveis e que deveria ser hachurado quando a ATA for publicada na página web da instituição.}

\item
A viagem do \censor{Fulano de Tal} não acontecerá.
\end{informes}
